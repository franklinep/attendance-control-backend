...
export const getUserInfoByGToken = async function (
  token: any
): Promise<GUserInfo> {
  ...
  try {
    ...
    console.log(
      "🚀 ~ file: auth.service.ts:18 ~ getUserInfoByGToken ~ userInfoResponse:",
      userInfoResponse
    );
    ...
    console.log(
      "🚀 ~ file: auth.service.ts:31 ~ getUserInfoByGToken ~ userInfoJson:",
      userInfoJson
    );
